        ...
        <div class="row">
                        ...
                        <div class="row border-top py-3 mt-3">
                            ...
                            <div class="col-sm-8">
                                ...
                                <div class="qty d-flex pt-2">
                                    ...
                                    <form method="post">
                                        <input type="hidden" value="<?php echo $item['id'] ?? 0; ?>" name="id">
                                        <button type="submit" name="wishlist-submit" class="btn  text-danger">Save for
                                            Later</button>
                                    </form>
            ...
            <div class="col-sm-3">
                <div class="sub-total border text-center mt-2">
                    <h6 class="font-size-12  text-success py-3"><i class="fas fa-check"></i> Your order is eligible for
                        FREE Delivery.</h6>
                    <div class="border-top py-4">
                        <h5 class=" font-size-20">Subtotal ( <?php echo isset($subTotal) ? count($subTotal) : 0; ?>
                            item):&nbsp; <span class="text-danger">$<span class="text-danger" id="deal-price">
